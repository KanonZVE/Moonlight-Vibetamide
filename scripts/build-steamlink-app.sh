...
mkdir -p $DEPLOY_FOLDER/steamlink/apps/vibetamide/bin
cp $BUILD_FOLDER/app/vibetamide $DEPLOY_FOLDER/steamlink/apps/vibetamide/bin/ || fail "Binary copy failed!"
cp $SOURCE_ROOT/app/deploy/steamlink/* $DEPLOY_FOLDER/steamlink/apps/vibetamide/ || fail "Metadata copy failed!"
pushd $DEPLOY_FOLDER
